...
@section('content')
        <!-- start page title -->
        <section class="page-title-parallax-background bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url({{asset('images/gambar/peradilan.jpg')}})">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 text-center position-relative page-title-extra-large">
                        <div class="d-flex flex-column extra-small-screen">
                            <div class="mt-auto">
                                <h1 class="text-white alt-font mb-0 text-shadow-extra-large fw-400 ls-minus-1px" data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["Peradilan Pidana"], "duration": 500, "delay": 0, "speed": 50, "easing": "easeOutQuad" }'></h1>
                            </div>
                            <!-- start breadcrumb -->
                            <div class="mt-auto justify-content-center breadcrumb breadcrumb-style-01 text-white">
                                <ul data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                                    <li><a href="demo-spa-salon.html" class="text-white">Beranda</a></li>
                                </ul>
                            </div>
                            <!-- end breadcrumb -->
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                    ...
                    <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-lg-start">
                        <h3 class="fw-700 text-dark-gray ls-minus-2px">Apa yang Dipelajari dalam Peradilan Pidana?</h3> 
                        {{-- @if ($tentang && $tentang->deskripsi)
                            <p class="mb-40px xs-mb-30px w-90 lg-w-95 md-w-100">{!! $tentang->deskripsi !!}></p>
                        @endif --}}
                        <p class="mb-40px xs-mb-30px w-90 lg-w-95 md-w-100">Program Studi Peradilan Pidana adalah program pendidikan yang berfokus pada penguasaan ilmu hukum pidana, sistem peradilan pidana, serta keterampilan dalam menangani proses hukum pidana dari penyidikan hingga putusan pengadilan. Mahasiswa akan dibekali dengan pemahaman mendalam terhadap hukum pidana materiil dan formil, serta praktik penyelesaian kasus secara adil dan profesional.</p> 
            ...
            <div class="container overlap-gap-section">
                ...
                <div class="row row-cols-1 row-cols-lg-4 justify-content-center gap-4 justify-content-center" data-anime='{ "el": "childs", "translateX": [-50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    ...
                    <div class="tw-p-4 tw-h-full tw-flex tw-flex-col tw-justify-between text-center process-step-style-02 hover-box last-paragraph-no-margin md-mb-50px">
                        ...
                        @endif --}}
                        <p>Menjadi Program Studi unggulan di bidang peradilan pidana yang berintegritas, profesional, dan berorientasi pada keadilan restoratif serta berwawasan global.</p>
                    </div>
                    ...
                    <div class="tw-p-4 tw-h-full tw-flex tw-flex-col tw-justify-between text-center process-step-style-02 hover-box last-paragraph-no-margin md-mb-50px">
                        ...
                        @endif --}}
                        <p>Menyelenggarakan pendidikan berkualitas di bidang hukum pidana dan sistem peradilan pidana terpadu.</p>
                    </div>
                    <!-- end process step item -->
                    <!-- start process step item -->
                    <div class="tw-p-4 tw-h-full tw-flex tw-flex-col tw-justify-between text-center process-step-style-02 hover-box last-paragraph-no-margin xs-mb-50px">
                        ...
                        @endif --}}
                        <p>Menghasilkan lulusan yang profesional di bidang hukum pidana dan sistem peradilan.</p>
                    </div>
                    <!-- end process step item -->
                </div>
                ...
                <div class="tw-flex tw-flex-col-reverse lg:tw-flex-row tw-items-center tw-gap-4" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                    <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-lg-start">
                        ...
                        <div class="tw-space-y-4 tw-text-justify tw-text-base tw-leading-relaxed tw-w-90 lg:tw-w-95 md:tw-w-full">
                            ...
                            @endif --}}
                            <p>Selamat datang di laman resmi Program Studi Peradilan Pidana. Kami hadir sebagai bentuk kontribusi nyata dalam mencetak sarjana hukum yang tidak hanya cakap secara teori, tetapi juga mampu menghadapi tantangan praktis di dunia peradilan. Melalui kurikulum yang komprehensif dan dosen yang kompeten, kami berkomitmen menciptakan lulusan yang siap bersaing di tingkat nasional maupun internasional.</p>
                        </div>
