        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Peradilan Pidana' => 'Kepala Program Studi Peradilan Pidana',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Peradilan Pidana') 
                ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Peradilan Pidana')
                ->columnSpanFull(),
            ]);
    }
